#!/bin/bash
#DSUB -n Taeniopygia-guttata-chrall_tiberius-hmm-500k_0519
#DSUB -A root.project.P24Z10200N0983
#DSUB -R 'cpu=32;gpu=1;mem=100000'
#DSUB -N 1
#DSUB -eo /home/share/huadjyin/home/s_sukui/03_project/01_GeneLLM/Tiberius/logs/Taeniopygia.guttata.chrall_tiberius.hmm.500k.%J.%I.err
#DSUB -oo /home/share/huadjyin/home/s_sukui/03_project/01_GeneLLM/Tiberius/logs/Taeniopygia.guttata.chrall_tiberius.hmm.500k.%J.%I.out
...
## Set scripts
RANK_SCRIPT="./scripts/tasks/Taeniopygia.guttata.chrall_tiberius.hmm.500k.sh"
