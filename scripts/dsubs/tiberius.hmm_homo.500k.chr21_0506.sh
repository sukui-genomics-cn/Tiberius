#!/bin/bash
#DSUB -n tiberius-hmm_homo-500k-chr21_0506
#DSUB -A root.project.P24Z10200N0983_tmp
#DSUB -R 'cpu=64;gpu=1;mem=120000'
#DSUB -N 1
#DSUB -eo /home/share/huadjyin/home/s_sukui/03_project/01_GeneLLM/Tiberius/logs/tiberius.hmm_homo.500k.chr21_0506.%J.%I.err
#DSUB -oo /home/share/huadjyin/home/s_sukui/03_project/01_GeneLLM/Tiberius/logs/tiberius.hmm_homo.500k.chr21_0506.%J.%I.out
...
## Set scripts
RANK_SCRIPT="./scripts/tasks/tiberius.hmm_homo.500k.chr21_0506.sh"
