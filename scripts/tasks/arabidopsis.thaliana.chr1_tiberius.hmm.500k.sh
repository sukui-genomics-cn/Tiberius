...
fasta_path=/home/share/huadjyin/home/yinpeng/dataset/weitong/with_TE/01.arabidopsis_thaliana/01.arabidopsis_thaliana.softmask.genome.fa
save_path=$root/outputs/arabidopsis.thaliana_tiberius.hmm
...
python bin/tiberius.py \
    ...
    --batch_size 2 \
    --chr_prefix "" \
    --out $save_path/arabidopsis.thaliana.chrall_tiberius.hmm.500k_0513.gtf
