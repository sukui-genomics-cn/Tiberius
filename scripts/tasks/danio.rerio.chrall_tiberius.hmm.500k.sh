...
fasta_path=/home/share/huadjyin/home/s_sukui/02_data/gene_structure/EvalDatasets/Danio_reio/Danio_rerio.longest.full.fna
...
python bin/tiberius.py \
    ...
    --genome $fasta_path \
    --batch_size 2 \
    --out $save_path/danio.rerio.chrall_.tiberius.hmm.500k_0519.gtf
